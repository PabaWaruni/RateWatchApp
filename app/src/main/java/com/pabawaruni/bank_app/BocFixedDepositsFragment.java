...
public class BocFixedDepositsFragment extends Fragment {
    Button button;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_boc_fixed_deposits, container, false);
    ...
    private void showWebViewDialog() {
        ...
        webView.loadUrl("https://www.boc.lk/rates-tariff#rupee-deposit-rates"); // link about the bank
    }
