...
public class SampathMapsFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_sampath_maps, container, false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        FirebaseDatabase.getInstance().getReference("Banks/Sampath")
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for (DataSnapshot placeSnapshot : dataSnapshot.getChildren()) {
                            ...
                            double longitude = placeSnapshot.child("Longtitude").getValue(Double.class);
...
//        // Move the camera to the user's location and zoom to level 8
