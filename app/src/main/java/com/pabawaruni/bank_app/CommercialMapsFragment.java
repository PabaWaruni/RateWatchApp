...
public class CommercialMapsFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_commercial_maps, container, false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        FirebaseDatabase.getInstance().getReference("Banks/Commercial")
