...
public class SampathFixedDepositsFragment extends Fragment {
    Button button;
    FloatingActionButton floatingActionButton ;
    CalculatorFragment calculatorFragment = new CalculatorFragment();
    ImageView imgSampathFixed;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sampath_fixed_deposits, container, false);
        ...
        button = view.findViewById(R.id.btnDetails);
    ...
    private void showWebViewDialog() {
        ...
        webView.loadUrl("https://www.sampath.lk/personal-banking/term-deposit-accounts/regular-deposits/Fixed-Deposits?category=personal_banking"); // link about the bank
    }
